  ...
  return (
    <div className="w-4/5 mx-auto flex flex-col items-center my-10">
      ...
      <div className="w-4/5 mx-auto my-4">
        <p class="text-green-500 text-2xl my-2">Members in Your house ?</p>
        <Select
      ...
      <div className="w-4/5 mx-auto my-4">
        <p class="text-green-500 text-2xl my-2">Size of your house ?</p>
        <Select
          className="text-gray-700"
          options={[
      ...
      <div className="w-4/5 mx-auto my-4">
        <p class="text-green-500 text-2xl my-2">Evaluate Your food choices</p>
        <Select
          className="text-gray-700"
          options={[
      ...
      <div className="w-4/5 mx-auto my-4">
        <p class="text-green-500 text-2xl my-2">
      ...
      {showScore && (
        <div className="my-10 flex items-center flex-col bg-green-300 w-4/5 mx-auto p-5 rounded-lg shadow-md">
